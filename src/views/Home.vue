<template>
  ...
  <div id="information1">
    <h2 id="info1">
      Diversify your portfolio and minimise risk. <br />
      Learn how to maximise your returns today!
    </h2>
    <img src="../assets/logo/PLACEHOLDERSCREENSHOT.png" /><br />
    <button id="signUpButton" :disabled="isSignedIn" @click="signUp">
      Sign up now!
    </button>
  </div>

  <div id="information2">
    <div id="info2Container2">
      <h2 id="info3">Keep track of all your investments in one place</h2>
    </div>
...
#signUpButton {
  ...
  background: #d8d6f5;
  box-shadow: 0px 0.24vw 0.24vw 0px rgba(0, 0, 0, 0.25);
}
...
#info3 {
  ...
  letter-spacing: -0.02vw;
  margin-bottom: 1vw;
  margin-right: 4vw; /* Add some right margin to prevent overflow */
}
